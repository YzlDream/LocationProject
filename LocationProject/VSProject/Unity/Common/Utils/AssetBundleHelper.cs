...
public static class AssetBundleHelper
{
    ...
    {        
        ...
        if (www2.error == null)//加载成功
        {
            ...
            if (obj == null)
            {
                ...
                Log.Alarm("LoadAssetObjectWithNoDep", "obj==null!!!\n"+Arrays.ToString(assetNames, "\n"));
    ...
    {
        //Debug.Log("AssetBundleHelper.LoadAssetWithSffixalName:"+loadName+"|"+suffixalName);
        Object obj = null;
        string fullname = loadName + suffixalName;
    ...
    //        else
    //        {
    //            Debug.Log(dicLoadingWWW[fileName].error);
    //            yield break;
    //        }
    //    }
