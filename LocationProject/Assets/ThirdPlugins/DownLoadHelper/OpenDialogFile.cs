...
public class OpenDialogFile : MonoBehaviour {
    ...
    public class OpenDialogFileParam
    {
    ...
    public class DllOpenFileDialog
    {
        ...
        public static extern bool GetOpenFileName([In, Out] OpenDialogFileParam ofn);

        [DllImport("Comdlg32.dll", SetLastError = true, ThrowOnUnmappableChar = true, CharSet = CharSet.Auto)]
        public static extern bool GetSaveFileName([In, Out] OpenDialogFileParam ofn);
