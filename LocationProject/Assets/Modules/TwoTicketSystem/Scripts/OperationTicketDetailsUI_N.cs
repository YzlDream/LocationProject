...
{
    public class OperationTicketDetailsUI_N : MonoBehaviour
    {
        public static OperationTicketDetailsUI_N Instance;
        /// <summary>
        /// 窗体
        /// </summary>
        public GameObject window;

        public OperationTicket info;//工作票信息
        ...
        public void Show(OperationTicket infoT)
        {
            info = infoT;
            UpdateData();
            CreateMeasuresItems();
        ...
        public void UpdateData()
        {
            ...
            TxtPlanTime.text = info.OperationStartTime.ToString("yyyy/MM/dd HH:mm") + "-" + info.OperationEndTime.ToString("yyyy/MM/dd HH:mm");
        ...
        public void CreateMeasuresItems()
        {
            ...
            foreach (OperationItem sm in info.OperationItems)
            {
