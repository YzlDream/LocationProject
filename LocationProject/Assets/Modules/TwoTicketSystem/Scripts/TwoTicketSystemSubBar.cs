...
public class TwoTicketSystemSubBar : MonoBehaviour {

    public static TwoTicketSystemSubBar Instance;
    ...
    public void HistoryToggle_OnValueChanged(bool ison)
    {
        ...
        {
            TwoTicketHistoryUI_N.Instance.SetContentActive(false);
        }

        //TwoTicketHistoryUI.Instance.SetWindowActive(ison);
